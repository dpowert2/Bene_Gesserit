...
*Last updated: 2026-05-03 (cycle 11 — reviewed, no changes; corpus stable at 73 votes) | Previous full rewrite: 2026-04-29 (cycle 10 — first run with live Turso vote stream) | Based on **73 live votes** (19 ★★★★★, 9 ★★★★, 8 ★★★, 15 ★★, 22 ★) — refreshed via `scripts/fetch-votes-from-turso.py` against the live `bg_votes` table. Previous cycles ran against an 8-vote stale cache from March; the 65-vote delta has been absorbed in this update. **NEW HARD FILTER (cycle 10):** "Operating system / workflow tool / SaaS-with-AI" → automatic 1★ rejection. Evidence — Avantos 1★ ("anything that bills itself as an operating system... not interested in workflow"), Marloo 1★ ("never looking for workflow management tools"), Asseta AI 1★ ("not a category reinvention. simply a SaaS tool for family offices. not novel"), IMTC 2★ ("looks more like a workflow automation tool"), Addition Wealth 2★ ("boring, done to death category. nothing innovative here. It just does basic things using AI"). The criterion isn't "what does it do" — it's "is it genuinely novel, a category reinvention, or a leap forward from the usual." **Wealth.com 1★ ("way too late. I'm seeking new and novelty. This is a major incumbent, not a startup")** confirms the stage gate is hard. **5★ signals on novel category-reinvention plays:** TYTL (tokenized residential RE — Anchorage custody full-stack), Versus (mass-market prediction app combining social/cultural/financial), Noise ("Love it" — attention market on Base). Pattern: novelty + retail democratisation + new asset surface = 5★. SaaS-with-AI = 1★.*
