...
*Last updated: 2026-05-19 | Version: 3.4 — Cycle 20. Vote corpus grew 94 → 97 entries (2 net-new star ratings + 1 new outreach marker). Greenboard 4★ (US Series A AI-native securities compliance for broker-dealers/RIAs) is the third confirming upvote in the "Compliance with Differentiation" pattern alongside Complyance 5★ and Norm-AI 4★ — preferences entry tightened. Deepflow 3★ (UK financial-crime agentic orchestration, NatWest Fintech Programme cohort) carries the note "looks more like an orchestration tool with some consultancy built in" — second occurrence of the consultancy-vs-product framing at human-review stage (companion to Alomana's deal-stage "feels more like a consultancy" softening); new emerging pattern logged at n=2. All v3.3 architecture intact.*
