...
**4. The decomposed family office — generational wealth, full lifecycle.** Emulate what a full-service family office does for the very wealthy, break it into its constituent jobs, and democratise each as an agent-callable service so an ordinary household gets the same machinery. Three framings make this novel rather than a robo-advisor rebrand. *The household is an SME with no finance function* — managing a family's full financial life is as complex as running a small business, but the only tool today is an episodic advisor; the opening is a continuous, always-on finance function. *The graph is social and societal, not just the nuclear family* — money flows through partners, godparents, communities, employer benefits, and state/federal programs, so the substrate must model the family in context. *Money moves both ways* — wealth flows down (parents fund children) and up (adult children support and care for aging parents); the sandwich generation does both at once. The lens is the full lifecycle — birth, school, college, first car, first home, marriage, business, illness, caring for a parent, retirement, inheritance, eldercare — and the system's job is to watch for each moment and act ahead of it. *Worked example:* "set aside $100/month for my child from birth" is a living decision the system owns — open the right vehicle (529 / custodial / trust), automate it, capture gift-tax-free room, pull in a contributing grandparent, re-point the pot when the goal shifts — compounding ~$21.6k of contributions to ~$39k by age 18 at 6%, managed every month for eighteen years.
*Geography:* the target **market is the US** (529s, UTMA/UGMA, gift/estate tax, AFR intra-family loans, Medicaid planning — the ~$84T great wealth transfer); the **supply is Europe-preferred**. The scout bar is **European-built AND a model that would work in the US in principle** — *not* "already serving US customers." A European company running on ISA/JISA today qualifies if its approach transfers to US instruments; US-instrument vocabulary is the search target, not a gate. Europe-preferred is not Europe-only — a strong US-built fit is a market-right context signal, not an automatic drop. *Guardrail:* this decomposes into a cluster of separate agent cells (see the Generational / Lifecycle cluster in the gap map) — it is emphatically **not** a "family-office-OS" super-app, which the global hard filter rejects. A candidate trying to be the whole cluster at once gets the archetype-overlap downweight, not a bonus.
*Reference signals:* the kids/family-investing layer is busy but mostly single-purpose savings apps (UNest, FutureMoney, Stockpile in the US; Beanstalk, Mia Wealth, ETF4Kids, Clanq, NestiFi in Europe — European craft, pointed at ISA/JISA not 529); financial-caregiving is the liveliest new cell (Carefull-style: myFloc, Napa Money, WayWiser); the continuous household-level orchestrator is the cleanest white space.

*The seven jobs of money — coverage check.* A household's money does seven things — it **earns**, **rests** (sits as idle cash), **invests**, **borrows**, is **protected**, is **saved**, and is **spent** — and something has to **orchestrate** all seven across the family. Mapped to the cluster and the specialist cells: *invest* is well covered (S1–S10); *protect* (Protection G7, Eldercare G8, Estate & Succession G3), *save* (Goal-Funding G4) and *borrow* (Family Lending G5) are covered; *earn* (income / benefits optimisation) and *rest* (idle-cash / liquidity placement) are the **open edges** — no dedicated cell yet, candidates for new cells; *spend* is deliberately constrained — generic budgeting/PFM is an anti-pattern, only tax-aware decumulation is in scope. **Orchestrate is the top-priority cell, not a nice-to-have:** the Life-Event Planning agent (G6) ties the seven jobs together across the household's social and societal fabric — people as a connected network, not isolated accounts. Startups that orchestrate across these pieces matter as much as those that own a single job.
...
### Generational / Lifecycle cluster (Studio, added v3.6)

The decomposed family office. US-market, Europe-preferred supply. Each is a separate scouting cell — never a single super-app. Codes are internal plumbing; the names are what matter.

| Cell | Traditional family-office function | Agent-first reimagining | Status |
|---|---|---|---|
| Social & Societal Graph (G1) | Consolidated reporting | The family-in-context as an agent-callable graph — members, accounts, benefits, programs, consent | ❌ Blind spot — only family-office software exists (asora, HeirWealth); mass-market graph open |
| Gifting & Estate-Tax (G2) | Gifting, trusts, tax-lot accounting | Execute wealth transfer tax-efficiently; pick the vehicle (529/UTMA/custodial Roth/trust) | ❌ Blind spot — white space; will-builders aren't tax-execution |
| Estate & Succession (G3) | Wills, succession | Wills, living trusts, POA/directives, beneficiary + digital-asset succession | ❌ Blind spot — crowded with document tools (Luminary, Trust&Will); agentic thinner |
| Goal-Funding (G4) | Education/goal saving | Pool multi-member contributions to a named goal, route to optimal vehicle | ❌ Blind spot — busiest adjacent layer (UNest, FutureMoney); mostly non-agentic savings apps |
| Family Lending (G5) | Intra-family lending | "Bank of mom & dad" systematised: AFR loans, gifted down-payments, co-sign, equity release | ❌ Blind spot |
| Life-Event Planning (G6, orchestrator) | The advisor relationship | Continuous finance function; anticipates milestones, fires the others; extends S8 | ❌ Blind spot — the cleanest white space; existing autopilots are individual, not family |
| Protection (G7) | Insurance | Life/income/disability sized to the family system and estate liability (ILITs) | ❌ Blind spot |
| Eldercare & Longevity (G8) | Later-life planning | LTC funding, Medicaid planning (5-yr lookback, asset-protection trusts), equity release | ❌ Blind spot |
| Caregiving & Sandwich-Gen (G9) | (none — upward flow) | Adult children coordinating & cost-sharing a parent's care and finances under POA | ❌ Blind spot — liveliest new cell (Carefull-style: myFloc, Napa Money, WayWiser) |
| Health & Medical-Cost (G10) | (none) | The money layer of illness — HSAs, medical-debt navigation, benefits optimisation (health-finance, not clinical) | ❌ Blind spot |
| Rising-Generation (G11) | Next-gen prep | Coach the next generation into competence; extends S9 | ❌ Blind spot — novelty risk high (kids-debit-card trap) |
