...
*Last updated: 2026-05-15 | Version: 3.3 — Cycle 18. Vote corpus grew 89 → 94 entries (1 net-new star rating + 4 new outreach markers). ANote Music 5★ is the first vote-confirmed entry on the R3 Tokenization / music-IP surface — added to Research sub-area 3 reference signals. Resistant-AI re-vote: the 5★ on the agentic-security angle stands, but the company was killed as a deal on stage ("should have caught it earlier") — challenge signal #4 annotated; reinforces that the stage gate must fire at carding, not post-vote. All v3.2 architecture intact.*
...
## Learned preferences (94 entries — 77 voted: 20 ★★★★★ · 11 ★★★★ · 8 ★★★ · 16 ★★ · 22 ★ · 17 0★ outreach markers)
